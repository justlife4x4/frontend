...
import { GrLocation, GrClearOption } from 'react-icons/gr';
...
const roomCategoryGridTariff = (props) => (
    <div>₹ {props.Tariff}</div>
);



export const roomCategoriesGrid = [
  { type: 'checkbox', width: '50', customAttributes: {class: 'customcss'}},
  { field: 'RoomCategoryName', headerText: 'Name', width: '150', textAlign: 'Left', customAttributes: {class: 'customcss'}},
  { field: 'Tariff', headerText: 'Tariff', width: '130', format: 'N2', textAlign: 'Right', template: roomCategoryGridTariff, customAttributes: {class: 'customcss'}},
  { field: 'MaxDiscount', headerText: 'Max. discount', width: '130', format: 'N2', textAlign: 'Right', customAttributes: {class: 'customcss'}},
  { field: 'ExtraBedTariff', headerText: 'Ext. bed', width: '130', format: 'N2', textAlign: 'Right', customAttributes: {class: 'customcss'}},
  { field: 'ExtraPersonTariff', headerText: 'Ext. person', width: '130', format: 'N2', textAlign: 'Right', customAttributes: {class: 'customcss'}},
  { field: 'RoomCategoryID', headerText: 'ID', width: '100', textAlign: 'Center', isPrimaryKey: true, visible: false, customAttributes: {class: 'customcss'}}
];
...
export const roomCategoriesData = [
  {
    RoomCategoryID: '1',
    RoomCategoryName: 'Super Delux (Top Floor)',
    Tariff: 1000.00,
    MaxDiscount: 200.00,
    ExtraBedTariff: 150.00,
    ExtraPersonTariff: 100.00,
    UpdatedDate: '01/01/1971',
    IsEnable: true
  },
  {
    RoomCategoryID: '2',
    RoomCategoryName: 'Delux (Top Floor)',
    Tariff: 1500.00,
    MaxDiscount: 250.00,
    ExtraBedTariff: 150.00,
    ExtraPersonTariff: 100.00,
  ...
  {
    RoomCategoryID: '3',
    RoomCategoryName: 'A/C (Top Floor)',
    Tariff: 2000.00,
    MaxDiscount: 200.00,
    ExtraBedTariff: 150.00,
    ExtraPersonTariff: 100.00,
  ...
  {
    RoomCategoryID: '4',
    RoomCategoryName: 'Non A/C (Top Floor)',
    Tariff: 2500,
    MaxDiscount: 200.00,
    ExtraBedTariff: 150.00,
    ExtraPersonTariff: 100.00,
  ...
  {
    RoomCategoryID: '5',
    RoomCategoryName: 'Super Delux (2nd Floor)',
    Tariff: 2000,
    MaxDiscount: 200.00,
    ExtraBedTariff: 100.00,
    ExtraPersonTariff: 100.00,
    UpdatedDate: '01/01/1971',
    IsEnable: true
  },
  {
    RoomCategoryID: '6',
    RoomCategoryName: 'Delux (2nd Floor)',
    Tariff: 2500,
    MaxDiscount: 200.00,
    ExtraBedTariff: 150.00,
    ExtraPersonTariff: 100.00,
  ...
  {
    RoomCategoryID: '7',
    RoomCategoryName: 'A/C (2nd Floor)',
    Tariff: 3000,
    MaxDiscount: 500.00,
    ExtraBedTariff: 200.00,
    ExtraPersonTariff: 200.00,
    UpdatedDate: '01/01/1971',
    IsEnable: true
  },
  {
    RoomCategoryID: '8',
    RoomCategoryName: 'Non A/C (2nd Floor)',
    Tariff: 2500,
    MaxDiscount: 600.00,
    ExtraBedTariff: 250.00,
    ExtraPersonTariff: 200.00,
    UpdatedDate: '01/01/1971',
    IsEnable: true
  },
  {
    RoomCategoryID: '9',
    RoomCategoryName: 'Super Delux (1st Floor)',
    Tariff: 3000,
    MaxDiscount: 700.00,
    ExtraBedTariff: 150.00,
    ExtraPersonTariff: 100.00,
  ...
  {
    RoomCategoryID: '10',
    RoomCategoryName: 'Delux (1st Floor)',
    Tariff: 4000,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
    UpdatedDate: '01/01/1971',
    IsEnable: true
  },
  {
    RoomCategoryID: '11',
    RoomCategoryName: 'A/C (1st Floor)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '12',
    RoomCategoryName: 'Non A/C (1st Floor)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '15',
    RoomCategoryName: 'Dormitory (10 Beds)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '16',
    RoomCategoryName: 'Dormitory (6 Beds)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '17',
    RoomCategoryName: 'Dormitory (4 Beds)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '19',
    RoomCategoryName: 'Cottage (A Block)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '20',
    RoomCategoryName: 'Cottage (B Block)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '21',
    RoomCategoryName: 'Cottage (C Block)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '22',
    RoomCategoryName: 'Cottage (D Block)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
  ...
  {
    RoomCategoryID: '23',
    RoomCategoryName: 'Cottage (E Block)',
    Tariff: 4500,
    MaxDiscount: 1000.00,
    ExtraBedTariff: 500.00,
    ExtraPersonTariff: 500.00,
